...
function App() {
  ...
  return <main className="game-page">
    <section className={`game-console ${phase === 'transition' ? 'is-transitioning' : ''}`}>
      ...
      <div className="top-actions"><button className="menu-key" onClick={() => setMenuOpen(true)}>E <span>Menu</span></button><button className="sound-key" onClick={toggleMute}>{started && !muted ? '♪ On' : '♪ Off'}</button></div>
